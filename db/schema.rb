...
ActiveRecord::Schema[7.0].define(version: 2025_05_07_111721) do
  ...
  create_table "sale_portions", force: :cascade do |t|
    t.datetime "from"
    t.datetime "till"
    t.bigint "user_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "verified_by_factory", default: false
    t.index ["user_id"], name: "index_sale_portions_on_user_id"
  end
  ...
  add_foreign_key "sale_portions", "users"
